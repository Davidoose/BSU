...
/*
Write the Main console program and two utilities (utility programs)
Creator and Reporter, which perform the following actions.
The Creator utility creates a binary file, the name of which and the number of entries in which
it receives via the command line.
*/
...
int main() {
	...
	// waiting for the completion of the Reporte
	...
	// output of {report_name} txt file
	...
	// end of output of {report_name} txt file
	return 0;
}